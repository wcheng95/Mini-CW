...
bool M5Unified::_speaker_enabled_cb_cardputer_adv(void* args, bool enabled)
{
    ...
    static constexpr const uint8_t enabled_bulk_data[] = {
      ...
      2, 0x13, 0x10,  // Enable output to HP drive
      2, 0x32, 0xBF,  // DAC volume 0 dB
      2, 0x37, 0x08,  // DAC EQ bypass
      0
    };

    // Important for Cardputer-Adv:
    // Speaker disable must really disable DAC/output path.
    // Do NOT reset whole ES8311 here, because ADC/mic may still be used.
    static constexpr const uint8_t disabled_bulk_data[] = {
      2, 0x32, 0x00,  // DAC volume minimum / mute-ish
      2, 0x12, 0x40,  // Power down DAC
      2, 0x13, 0x00,  // Disable output to HP drive
      0
    };
